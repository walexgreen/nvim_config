...
-- Go to file exporer with <leader>pv
...
function OpenTerminalSplit()
  -- Replace 10 with your desired height
...
require('lazy').setup({
    ...
    config = function()
      ...
      local config = {
        ...
        cmd = {
          ...
          -- fixed
          '-jar',
          '/home/hydroakri/.local/share/nvim/mason/packages/jdtls/plugins/org.eclipse.equinox.launcher_1.6.800.v20240304-1850.jar',
          -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                       ^^^^^^^^^^^^^^
  ...
  -- TODO: Figure out how to configure bufferline
  {
  ...
  -- { 'arzg/vim-colors-xcode' }, -- Uncomment this and use for xcode theme
  { -- You can easily change to a different colorscheme.
    ...
    init = function()
      ...
      -- Rose pine is isntalled above, activated here
      vim.cmd.colorscheme 'no-clown-fiesta'
      vim.api.nvim_set_hl(0, 'Normal', { bg = 'none' })
      vim.api.nvim_set_hl(0, 'NormalFloat', { bg = 'none' })
      vim.o.term_gui_colors = true
